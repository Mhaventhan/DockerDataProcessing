...
# file_path=os.walk()
#
# folder_content=os.walk(file_path)
# print(file_path)
...
file_path=os.getcwd()
print(file_path,"___> FILEPATH")

onlyfiles = [f for f in listdir(file_path) if isfile(join(file_path, f))]
print(onlyfiles,"___> Files")

from botocore.exceptions import NoCredentialsError
local_file="dataclean.csv"
bucket = "kubeflow-datareply"
s3_file="dataclean.csv"

def upload_to_aws(local_file, bucket, s3_file):
    s3 = boto3.client('s3',aws_access_key_id = aws_access,aws_secret_access_key = aws_secret)
    print(s3)
    # print(s3.buckets[bucket].exist?)
    try:
