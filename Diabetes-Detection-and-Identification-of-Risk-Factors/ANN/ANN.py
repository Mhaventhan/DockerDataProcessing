...
#First Hidden Layer
classifier.add(Dense(100, activation='relu', kernel_initializer='random_normal', input_dim=20))
...
plt.xlabel('epochs')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('NNloss.png', dpi=300, bbox_inches='tight')
plt.show()

eval_model_test = classifier.evaluate(X_test, y_test) #[0.1655, 0.9405]

eval_model_train=classifier.evaluate(X_train, y_train) #[0.1584, 0.9482]
